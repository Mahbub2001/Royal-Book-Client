...
const AllSellers = () => {
  ...
  return (
    <section>
      <h1 className="mt-40 my-10 text-5xl text-center">ALL SELLERS</h1>
                    ...
                    {sellers?.map((seller) => (
                      <tr key={seller._id}>
                        <td className="p-2 whitespace-nowrap">
                          <div className="text-left">{seller?.name}</div>
                        </td>
                        <td className="p-2 whitespace-nowrap">
                        ...
                        <td className="p-2 whitespace-nowrap ">
                          {seller?.verify ? (
                            <button
                              ...
                              className="lg:ml-12 md:ml-4 inline-flex items-center px-4 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-md"
                            >
                              Verified
                            </button>
                          ) : (
                        ...
                        <td className="p-2 whitespace-nowrap ">
                          <button
                            ...
                            className="lg:ml-16 md:ml-4 inline-flex items-center px-4 py-2 bg-red-600 hover:bg-red-700 text-white text-sm font-medium rounded-md"
                          >
                            <svg
